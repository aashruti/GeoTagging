...
import com.example.geotagging.dialog.PickerDialog;
import com.example.geotagging.dialog.SimplePickerDialog;
import com.example.geotagging.options.AspectRatioItem;
import com.example.geotagging.options.Commons;
import com.example.geotagging.options.SizeItem;
...
public class PhotographerActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        photographerHelper.setFileDir(PhotographerActivity.this.getExternalFilesDir(null)+"/GeoTagging");
